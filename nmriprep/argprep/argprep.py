...
def main():
    ...
    flatfield_correction['dark'] = find_fields(args.dark_field, out_dir.glob('*darkfield.tif*'))
    flatfield_correction['flat'] = find_fields(args.flat_field, out_dir.glob('*flatfield.tif*'))
